    ...
    <div className="min-h-screen bg-gradient-to-br from-agricultural-50 to-earth-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Welcome back to your farming companion</p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <Link href="/forgot-password" className="text-agricultural-600 hover:underline">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-6 text-center text-sm">
              ...
              <Link href="/signup" className="text-agricultural-600 hover:underline font-medium">
                Sign up
              </Link>
            </div>
          </CardContent>
